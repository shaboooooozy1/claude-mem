...
| `CLAUDE_MEM_SKIP_TOOLS`       | `ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,TaskCreate,TaskUpdate,TaskGet,TaskList,AskUserQuestion` | Comma-separated tools to exclude from observations |
...
- Include TodoWrite / TaskCreate / TaskUpdate / TaskGet / TaskList: Remove from skip list to track task planning
